...
---
name: fal_image
description: Generate a high-quality image using fal.ai $FAL_MODEL_NAME. Use this when the user asks to generate an image, create a thumbnail, visualize something.
---
